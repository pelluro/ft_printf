...
//	printf("%d\n\n", printf("1octal 1 %o octal 2 %o\n\n", 42, -42));
	...
	printf("\n----------------Verification test non defini ------------\n");
	
	ft_printf("test de #8x=%#8x\n", 42);
	printf("test de #8x=%#8x\n\n", 42);
	...
	ft_printf("on teste1 le hhl=%5+#hhld\n", 128);
	printf("on teste1 le hhl=%5+#hhld\n\n", 128);
